...
/// Checkout our developer doc on our token standard https://depay_.dev/standards
module depay_token::token {
    use std::error;
    ...
    use depay_token::property_map::{Self, PropertyMap, PropertyValue};
    use depay_token::token_event_store;
    ...
    public entry fun test_collection_maximum(creator: signer) acquires Collections, TokenStore {
        ...
        create_token_script(
            ...
            100,
            2,
            string::utf8(b"https://depay_.dev"),
