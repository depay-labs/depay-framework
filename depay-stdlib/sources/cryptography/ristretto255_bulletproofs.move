...
module depay_std::ristretto255_bulletproofs {
    use std::error;
    use std::features;
    use depay_std::ristretto255_pedersen as pedersen;
    use depay_std::ristretto255::{Self, RistrettoPoint};
    ...
    #[test_only]
    use depay_std::ristretto255::{Scalar, scalar_to_bytes, point_equals};

    #[test_only]
    const A_DST: vector<u8> = b"DePayBulletproofs";
    #[test_only]
