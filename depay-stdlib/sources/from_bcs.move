...
/// a general conversion back-and-force is needed, consider the `depay_std::Any` type which preserves invariants.
///
/// Example:
/// ```
/// use std::bcs;
...
module depay_std::from_bcs {
    ...
    friend depay_std::any;
    friend depay_std::copyable_any;
