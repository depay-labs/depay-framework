...
use depay_gas_schedule::gas_params::natives::move_stdlib::*;
use depay_native_interface::{
...
fn native_sub_string(
    ...
    if j < i {
        ...
        return Err(depay_native_interface::SafeNativeError::Abort { abort_code: 1 });
    }
