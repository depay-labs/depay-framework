...
module depay_framework::primary_fungible_store {
    use depay_framework::dispatchable_fungible_asset;
    use depay_framework::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata, MintRef, TransferRef, BurnRef};
    use depay_framework::object::{Self, Object, ConstructorRef, DeriveRef};
    ...
    #[test_only]
    use depay_framework::fungible_asset::{
        create_test_token,
        generate_mint_ref,
        generate_burn_ref,
