...
module depay_framework::reconfiguration_with_dkg {
    use std::features;
    use std::option;
    use depay_framework::consensus_config;
    use depay_framework::dkg;
    use depay_framework::execution_config;
    use depay_framework::gas_schedule;
    use depay_framework::jwk_consensus_config;
    use depay_framework::jwks;
    use depay_framework::keyless_account;
    use depay_framework::randomness_api_v0_config;
    use depay_framework::randomness_config;
    use depay_framework::randomness_config_seqnum;
