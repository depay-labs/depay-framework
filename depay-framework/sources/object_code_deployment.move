...
module depay_framework::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::features;
    use std::signer;
    ...
    use depay_framework::code;
    use depay_framework::code::PackageRegistry;
    use depay_framework::event;
    use depay_framework::object;
    use depay_framework::object::{ExtendRef, Object};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"depay_framework::object_code_deployment";
