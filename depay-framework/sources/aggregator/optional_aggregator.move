...
module depay_framework::optional_aggregator {
    use std::error;
    use std::option::{Self, Option};

    use depay_framework::aggregator_factory;
    use depay_framework::aggregator::{Self, Aggregator};
    ...
    #[test(account = @depay_framework)]
    #[expected_failure(abort_code = 0x020001, location = depay_framework::aggregator)]
    ...
    #[test(account = @depay_framework)]
    #[expected_failure(abort_code = 0x020002, location = depay_framework::aggregator)]
