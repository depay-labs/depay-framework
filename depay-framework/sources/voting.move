...
module depay_framework::voting {
    ...
    public fun create_proposal_with_empty_execution_hash_should_fail_generic(
        ...
        account::create_account_for_test(@depay_framework);
        let governance_address = signer::address_of(governance);
    ...
    #[test(depay_framework = @depay_framework, governance = @0x123)]
    public entry fun test_voting_passed(depay_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_generic(depay_framework, governance, false, false);
    }

    #[test(depay_framework = @depay_framework, governance = @0x123)]
    public entry fun test_voting_passed_multi_step(depay_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_generic(depay_framework, governance, true, true);
    }
    ...
    public entry fun test_voting_passed_multi_step_cannot_use_single_step_resolve_function(
        ...
        test_voting_passed_generic(depay_framework, governance, true, false);
    }
    ...
    public entry fun test_voting_passed_single_step_can_use_generic_function(
        ...
        test_voting_passed_generic(depay_framework, governance, false, true);
    }
    ...
    public entry fun test_cannot_resolve_twice(depay_framework: &signer, governance: &signer) acquires VotingForum {
        test_cannot_resolve_twice_generic(depay_framework, governance, false);
    }
    ...
    public entry fun test_cannot_resolve_twice_multi_step(
        ...
        test_cannot_resolve_twice_generic(depay_framework, governance, true);
    }
    ...
    #[test(depay_framework = @depay_framework, governance = @0x123)]
    public entry fun test_voting_passed_early(depay_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_passed_early_generic(depay_framework, governance, false);
    }
    ...
    public entry fun test_voting_passed_early_multi_step(
        ...
        test_voting_passed_early_generic(depay_framework, governance, true);
    }
    ...
    public entry fun test_voting_passed_early_in_same_tx_should_fail(
        ...
        test_voting_passed_early_in_same_tx_should_fail_generic(depay_framework, governance, false);
    }
    ...
    public entry fun test_voting_passed_early_in_same_tx_should_fail_multi_step(
        ...
        test_voting_passed_early_in_same_tx_should_fail_generic(depay_framework, governance, true);
    }
    ...
    public entry fun test_voting_failed(depay_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_generic(depay_framework, governance, false);
    }

    #[test(depay_framework = @depay_framework, governance = @0x123)]
    #[expected_failure(abort_code = 0x30002, location = Self)]
    public entry fun test_voting_failed_multi_step(depay_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_generic(depay_framework, governance, true);
    }
    ...
    #[test(depay_framework = @depay_framework, governance = @0x123)]
    #[expected_failure(abort_code = 0x30002, location = Self)]
    public entry fun test_voting_failed_early(depay_framework: &signer, governance: &signer) acquires VotingForum {
        test_voting_failed_early_generic(depay_framework, governance, true);
    }
    ...
    public entry fun test_voting_failed_early_multi_step(
        ...
        test_voting_failed_early_generic(depay_framework, governance, false);
    }
    ...
    public entry fun test_cannot_set_min_threshold_higher_than_early_resolution(
        ...
        test_cannot_set_min_threshold_higher_than_early_resolution_generic(depay_framework, governance, false);
    }
    ...
    public entry fun test_cannot_set_min_threshold_higher_than_early_resolution_multi_step(
        ...
        test_cannot_set_min_threshold_higher_than_early_resolution_generic(depay_framework, governance, true);
    }

    #[test(depay_framework = @depay_framework, governance = @0x123)]
    public entry fun test_replace_execution_hash(depay_framework: &signer, governance: &signer) acquires VotingForum {
        account::create_account_for_test(@depay_framework);
        timestamp::set_time_has_started_for_testing(depay_framework);
