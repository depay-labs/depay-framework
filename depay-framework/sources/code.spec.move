spec depay_framework::code {
    ...
    /// Enforcement: The DePay upgrade native functions have been manually audited.
    ///
    /// No.: 2
    ...
    spec initialize(depay_framework: &signer, package_owner: &signer, metadata: PackageMetadata) {
