...
module depay_framework::chain_status {
    ...
    public(friend) fun set_genesis_end(depay_framework: &signer) {
        system_addresses::assert_depay_framework(depay_framework);
        move_to(depay_framework, GenesisEndMarker {});
    }

    #[view]
    /// Helper function to determine if DePay is in genesis state.
    public fun is_genesis(): bool {
        !exists<GenesisEndMarker>(@depay_framework)
    }
