...
module depay_framework::managed_coin {
    use std::string;
    use std::error;
    use std::signer;

    use depay_framework::coin::{Self, BurnCapability, FreezeCapability, MintCapability, destroy_burn_cap,
    ...
    /// Initialize new coin `CoinType` in DePay Blockchain.
    ...
    public entry fun test_end_to_end(
        ...
        depay_framework::account::create_account_for_test(source_addr);
        depay_framework::account::create_account_for_test(destination_addr);
        depay_framework::account::create_account_for_test(signer::address_of(&mod_account));
    ...
    public entry fun fail_mint(
        ...
        depay_framework::account::create_account_for_test(source_addr);
        depay_framework::account::create_account_for_test(signer::address_of(&destination));
        depay_framework::account::create_account_for_test(signer::address_of(&mod_account));
        aggregator_factory::initialize_aggregator_factory_for_test(&mod_account);
