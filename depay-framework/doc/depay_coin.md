...
<dl>
<dt>
<code>inner: <a href="../../depay-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="depay_coin.md#0x1_depay_coin_DelegatedMintCapability">depay_coin::DelegatedMintCapability</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="depay_coin.md#0x1_depay_coin_initialize">initialize</a>(depay_framework: &<a href="../../depay-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>): (BurnCapability&lt;<a href="depay_coin.md#0x1_depay_coin_DePayCoin">DePayCoin</a>&gt;, MintCapability&lt;<a href="depay_coin.md#0x1_depay_coin_DePayCoin">DePayCoin</a>&gt;) {
    ...
    <b>let</b> (burn_cap, freeze_cap, mint_cap) = <a href="coin.md#0x1_coin_initialize_with_parallelizable_supply">coin::initialize_with_parallelizable_supply</a>&lt;<a href="depay_coin.md#0x1_depay_coin_DePayCoin">DePayCoin</a>&gt;(
        depay_framework,
        <a href="../../depay-stdlib/../move-stdlib/doc/string.md#0x1_string_utf8">string::utf8</a>(b"DePay Coin"),
        <a href="../../depay-stdlib/../move-stdlib/doc/string.md#0x1_string_utf8">string::utf8</a>(b"DPT"),
        8, // decimals
...
<pre><code><b>public</b> <b>fun</b> <a href="depay_coin.md#0x1_depay_coin_has_mint_capability">has_mint_capability</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../depay-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>): bool {
    <b>exists</b>&lt;<a href="depay_coin.md#0x1_depay_coin_MintCapStore">MintCapStore</a>&gt;(<a href="../../depay-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="account.md#0x1_account">account</a>))
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="depay_coin.md#0x1_depay_coin_destroy_mint_cap">destroy_mint_cap</a>(depay_framework: &<a href="../../depay-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) <b>acquires</b> <a href="depay_coin.md#0x1_depay_coin_MintCapStore">MintCapStore</a> {
    <a href="system_addresses.md#0x1_system_addresses_assert_depay_framework">system_addresses::assert_depay_framework</a>(depay_framework);
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="depay_coin.md#0x1_depay_coin_configure_accounts_for_test">configure_accounts_for_test</a>(
    ...
    core_resources: &<a href="../../depay-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    ...
    <a href="coin.md#0x1_coin_deposit">coin::deposit</a>&lt;<a href="depay_coin.md#0x1_depay_coin_DePayCoin">DePayCoin</a>&gt;(<a href="../../depay-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(core_resources), coins);

    <b>move_to</b>(core_resources, <a href="depay_coin.md#0x1_depay_coin_MintCapStore">MintCapStore</a> { mint_cap });
    <b>move_to</b>(core_resources, <a href="depay_coin.md#0x1_depay_coin_Delegations">Delegations</a> { inner: <a href="../../depay-stdlib/../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>() });
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="depay_coin.md#0x1_depay_coin_mint">mint</a>(
    ...
    <b>assert</b>!(
        ...
        <a href="../../depay-stdlib/../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="depay_coin.md#0x1_depay_coin_ENO_CAPABILITIES">ENO_CAPABILITIES</a>),
    );
...
<pre><code><b>public</b> entry <b>fun</b> <a href="depay_coin.md#0x1_depay_coin_delegate_mint_capability">delegate_mint_capability</a>(<a href="account.md#0x1_account">account</a>: <a href="../../depay-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, <b>to</b>: <b>address</b>) <b>acquires</b> <a href="depay_coin.md#0x1_depay_coin_Delegations">Delegations</a> {
    ...
    <a href="../../depay-stdlib/../move-stdlib/doc/vector.md#0x1_vector_for_each_ref">vector::for_each_ref</a>(delegations, |element| {
        <b>let</b> element: &<a href="depay_coin.md#0x1_depay_coin_DelegatedMintCapability">DelegatedMintCapability</a> = element;
        <b>assert</b>!(element.<b>to</b> != <b>to</b>, <a href="../../depay-stdlib/../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="depay_coin.md#0x1_depay_coin_EALREADY_DELEGATED">EALREADY_DELEGATED</a>));
    });
    <a href="../../depay-stdlib/../move-stdlib/doc/vector.md#0x1_vector_push_back">vector::push_back</a>(delegations, <a href="depay_coin.md#0x1_depay_coin_DelegatedMintCapability">DelegatedMintCapability</a> { <b>to</b> });
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="depay_coin.md#0x1_depay_coin_claim_mint_capability">claim_mint_capability</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../depay-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) <b>acquires</b> <a href="depay_coin.md#0x1_depay_coin_Delegations">Delegations</a>, <a href="depay_coin.md#0x1_depay_coin_MintCapStore">MintCapStore</a> {
    <b>let</b> maybe_index = <a href="depay_coin.md#0x1_depay_coin_find_delegation">find_delegation</a>(<a href="../../depay-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="account.md#0x1_account">account</a>));
    <b>assert</b>!(<a href="../../depay-stdlib/../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(&maybe_index), <a href="depay_coin.md#0x1_depay_coin_EDELEGATION_NOT_FOUND">EDELEGATION_NOT_FOUND</a>);
    <b>let</b> idx = *<a href="../../depay-stdlib/../move-stdlib/doc/option.md#0x1_option_borrow">option::borrow</a>(&maybe_index);
    <b>let</b> delegations = &<b>mut</b> <b>borrow_global_mut</b>&lt;<a href="depay_coin.md#0x1_depay_coin_Delegations">Delegations</a>&gt;(@core_resources).inner;
    <b>let</b> <a href="depay_coin.md#0x1_depay_coin_DelegatedMintCapability">DelegatedMintCapability</a> { <b>to</b>: _ } = <a href="../../depay-stdlib/../move-stdlib/doc/vector.md#0x1_vector_swap_remove">vector::swap_remove</a>(delegations, idx);
...
<pre><code><b>fun</b> <a href="depay_coin.md#0x1_depay_coin_find_delegation">find_delegation</a>(addr: <b>address</b>): Option&lt;u64&gt; <b>acquires</b> <a href="depay_coin.md#0x1_depay_coin_Delegations">Delegations</a> {
    ...
    <b>let</b> i = 0;
    <b>let</b> len = <a href="../../depay-stdlib/../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(delegations);
    <b>let</b> index = <a href="../../depay-stdlib/../move-stdlib/doc/option.md#0x1_option_none">option::none</a>();
    <b>while</b> (i &lt; len) {
        <b>let</b> element = <a href="../../depay-stdlib/../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(delegations, i);
        <b>if</b> (element.<b>to</b> == addr) {
            index = <a href="../../depay-stdlib/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(i);
            <b>break</b>
        };
        i = i + 1;
    };
