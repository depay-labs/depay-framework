...
module 0xcafe::deflation_token {
    use depay_framework::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    use depay_framework::dispatchable_fungible_asset;
    use depay_framework::object::{ConstructorRef, Object};
    ...
    #[test_only]
    use depay_framework::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status=4037, location=depay_framework::dispatchable_fungible_asset)]
