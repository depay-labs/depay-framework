...
module 0xcafe::deflation_token_tests {
    ...
    use depay_framework::dispatchable_fungible_asset;
    use depay_framework::function_info;
    use depay_framework::fungible_asset::{Self, Metadata, TestToken};
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x70002, location = depay_framework::dispatchable_fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001C, location = depay_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x8001D, location = depay_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x10019, location = depay_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001A, location = depay_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001B, location = depay_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(major_status=1081, location = depay_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=2, location = depay_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=0x6001E, location = depay_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x50008, location = depay_framework::fungible_asset)]
